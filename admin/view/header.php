...
<body>
            ...
            <div class="menu" style="margin-bottom:10px">
                ...
                <div class="dropdown">
                    ...
                    <ul class="dropdown-menu dropdown-menu-light">
                        <li><a class="dropdown-item " href="/LaptopWorld/">Trở về trang chủ</a></li>
    ...
    echo '<div class="alert alert-danger" role="alert" style="text-align: center;font-size: 18px; font-weight: bold; color: red">
