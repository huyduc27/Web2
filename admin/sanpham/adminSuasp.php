<div class="container" style="padding-top: 20px;">
    <form class="row" action="index.php?act=adminSuasp" method="post" enctype="multipart/form-data">
        ...
        <div class="form-floating mb-3 col-6">
            <input type="text" class="form-control" id="floatingInput" placeholder="Tên sản phẩm" name="tensp"
        ...
        <div class="form-floating mb-3 col-6">
            <select class="form-select form-select-lg mb-3"
                ...
                <option value="<?php echo $a['id_dm']; ?>" <?php echo ($a['id_dm'] == $id_dm) ? 'selected' : ''; ?>>
                    <?php echo $a['name']; ?>
                </option>
                <?php endforeach; ?>
            </select>
        ...
        <div class="form-floating mb-3 col-12">
            <textarea class="form-control" style="max-height: 150px; overflow: auto; height: 100%" id="floatingTextarea"
                placeholder="Mô tả sản phẩm" name="mota" cols="30" rows="10" required><?php echo $mota; ?></textarea>
