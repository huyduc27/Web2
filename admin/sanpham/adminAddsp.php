<div class="container" style="padding-top: 20px;">
    <form class="row" action="index.php?act=themsp" method="post" enctype="multipart/form-data"
        ...
        <div class="form-floating mb-3 col-6">
            <textarea class="form-control" id="mota" placeholder="Mô tả sản phẩm" name="mota" required cols="30"
                rows="10"></textarea>
        ...
        <div class="d-grid">
            <button class="btn btn-lg btn-primary btn-login text-uppercase fw-bold mb-2" type="submit"
                name="themsp">Thêm sản phẩm</button>
        </div>
    </form>
</div>