...
<div class="donhang">
        ...
        <div class="khungCTDH">
            ...
            <div class="khung-tiendo" style="padding: 30px 20px;">
                <div class="tiendo" style="">
                    <?php $tt = $a['trangthai'] ?>
                    <?php if($tt == 1){ ?>
                    <div class="tt-tiendo1"
                        style="border: 1px solid none; width: 121px; text-align: center; z-index: 1; ">
                        <div class="icon1" style="display: flex; justify-content: center; align-items: center;"><i
                                class="fa-solid fa-receipt"
                                style="font-size: 35px; border: 4px solid #2dc258; padding: 10px 15px 11px 15px; border-radius: 50%; background-color: #fff; color: #2dc258;"></i>
                        </div>
                        <div class="text1">Đơn hàng đã đặt</div>
                        <div class="time1" style="font-size: .75rem; color: rgba(0,0,0,.26); height: .875rem;">
                            <?php echo $a['date'] ?></div>
                    </div>
                    <div class="tt-tiendo2"
                        style="border: 1px solid none; width: 121px; text-align: center; z-index: 1;">
                        <div class="icon2" style="display: flex; justify-content: center; align-items: center;"><i
                                class="fa-solid fa-clipboard-check"
                                style="font-size: 35px; border: 4px solid #2dc258; padding: 9px 15px 10px 15px; border-radius: 50%; background-color: #fff; color: #2dc258;"></i>
                        </div>
                        <div class="text2">Chờ xác nhận</div>
                        <div class="time2" style="font-size: .75rem; color: rgba(0,0,0,.26); height: .875rem;">
                            <?php echo $a['date'] ?></div>
                    </div>
                    <div class="tt-tiendo2"
                        style="border: 1px solid none; width: 121px; text-align: center; z-index: 1;">
                        <div class="icon2" style="display: flex; justify-content: center; align-items: center;"><i
                                ...
                                style="font-size: 35px; border: 4px solid #e0e0e0; padding: 12px 10px 10px 10px; border-radius: 50%; background-color: #fff; color: #e0e0e0;"></i>
                        </div>
                    ...
                    <div class="tt-tiendo2"
                        ...
                        <div class="icon2" style="display: flex; justify-content: center; align-items: center;"><i
                                ...
                                style="font-size: 35px; border: 4px solid #e0e0e0; padding: 12px 10px 12px 10px; border-radius: 50%; background-color: #fff; color: #e0e0e0;"></i>
                        </div>
                    ...
                    <div class="tt-tiendo2"
                        ...
                        <div class="icon2" style="display: flex; justify-content: center; align-items: center;"><i
                                ...
                                style="font-size: 35px; border: 4px solid #e0e0e0; padding: 12px 9px 10px 9px; border-radius: 50%; background-color: #fff; color: #e0e0e0;"></i>
                        </div>
                    ...
                    <div class="duongke2"
                        style="border: 3px solid #e0e0e0; width: 90%; position: absolute; top:29px; margin-left: 48px;">
                    </div>
                    <div class="duongke"
                        style="border: 3px solid #2dc258; width: 22%; position: absolute; top:29px; margin-left: 48px;">
                    </div>
                    <?php } ?>
                    <?php if ($tt == 2){ ?>
                    <div class="tt-tiendo1"
                    ...
                    <div class="tt-tiendo2"
                        ...
                        <div class="icon2" style="display: flex; justify-content: center; align-items: center;"><i
                                class="fa-solid fa-dolly"
                                style="font-size: 35px; border: 4px solid #2dc258; padding: 12px 10px 10px 10px; border-radius: 50%; background-color: #fff; color: #2dc258;"></i>
                        </div>
                        <div class="text2">Chờ lấy hàng</div>
                        <div class="time3" style="font-size: .75rem; color: rgba(0,0,0,.26); height: .875rem;">
                            <?php echo $a['date2'] ?></div>
                    </div>
                    <div class="tt-tiendo2"
                        style="border: 1px solid none; width: 121px; text-align: center; z-index: 1;">
                        <div class="icon2" style="display: flex; justify-content: center; align-items: center;"><i
                    ...
                    <div class="duongke"
                        style="border: 3px solid #2dc258; width: 45%; position: absolute; top:29px; margin-left: 48px;">
                    </div>
                    <?php } ?>
                    <?php if ($tt == 3){ ?>
                    <div class="tt-tiendo1"
                    ...
                    <div class="tt-tiendo2"
                        ...
                        <div class="icon2" style="display: flex; justify-content: center; align-items: center;"><i
                                class="fa-solid fa-truck-fast"
                                style="font-size: 35px; border: 4px solid #2dc258; padding: 12px 10px 12px 10px; border-radius: 50%; background-color: #fff; color: #2dc258;"></i>
                        </div>
                        <div class="text2">Chờ giao hàng</div>
                        <div class="time4" style="font-size: .75rem; color: rgba(0,0,0,.26); height: .875rem;">
                            <?php echo $a['date3'] ?></div>
                    </div>
                    <div class="tt-tiendo2"
                        style="border: 1px solid none; width: 121px; text-align: center; z-index: 1;">
                        <div class="icon2" style="display: flex; justify-content: center; align-items: center;"><i
                    ...
                    <div class="duongke"
                        style="border: 3px solid #2dc258; width: 67%; position: absolute; top:29px; margin-left: 48px;">
                    </div>
                    <?php } ?>
                    <?php if ($tt == 4){ ?>
                    <div class="tt-tiendo1"
                    ...
                    <div class="tt-tiendo2"
                        ...
                        <div class="icon2" style="display: flex; justify-content: center; align-items: center;"><i
                                class="fa-solid fa-box-open"
                                style="font-size: 35px; border: 4px solid #2dc258; padding: 12px 9px 10px 9px; border-radius: 50%; background-color: #fff; color: #2dc258;"></i>
                        </div>
                        <div class="text2">Đã giao</div>
                        <div class="time5" style="font-size: .75rem; color: rgba(0,0,0,.26); height: .875rem;">
                            <?php echo $a['date4'] ?></div>
                    </div>
                    ...
                    <div class="duongke"
                        style="border: 3px solid #2dc258; width: 90%; position: absolute; top:29px; margin-left: 48px;">
                    </div>
                    <?php } ?>
                    <?php if($tt == 0){ ?>
                    <div class="tbhuy"
                        style="width: 100%; height: auto; text-align: center; padding: 0px; margin: 0px;">
                        <p style="padding: 0px; margin: 0px; font-size: 20px; font-style: italic; color: #a9a8a8;">Đơn
                            hàng đã được hủy</p>
                    </div>
                    <?php } ?>
                </div>
        ...
        <div class="sanpham_donhang" style="
            ...
            <div class="img">
                <img style="
                    width: 100px;
                    height: 100px;
                    margin: 5px;" src="img/sanpham/<?php echo $b['img_sp'] ?>" alt="" />
            </div>
            <!-- TÊN SP -->
            <div class="tensanpham" style="padding-top: 22px; width: 735px; margin-left: 5px;">
                <a style="text-decoration: none"
                    href="index.php?act=chitietsanpham&id_chitiet=<?php echo $b['id_chitiet'] ?>&id_pro=<?php echo $id_pro; ?>"><?php echo $b['tensp'] ?></a>
                <br />
                <br />
                <div class="soluong">
    ...
    <div class="form-tongtien" style="padding-top: 50px; background-color: #fffefb;">
        <div class="tong-tien"
            style="display: flex; float: right; margin-right: 2%; font-size: 17px;background-color: #fffefb;">
    ...
    <form action="index.php?act=xacnhan_mua_huy" method="post">
        <div class="a" style="background-color: #fffefb; margin-bottom: 30px;">
            ...
            <div class="luuy" style="">
                <p
                    style="text-align: right; margin: 0px; padding: 0px; padding-bottom: 10px; padding-right: 10px; color: red; font-style: italic;">
                    Chỉ bấm "Đã nhận" khi đã nhận được hàng!</p>
            </div>
            <?php } ?>
        </div>
    </form>
