...
<body>
    <div class="preload-image" style="left: 33%;"></div>
                                    ...
                                    <div class="loai-danh-muc">
                                        ...
                                        <div class="san-pham-danh-muc">
                                            ...
                                            <div class="san-pham-danh-muc2">
                                                <a
                                                    href="index.php?act=sanpham&brand=<?php echo $sanpham['name'] ?>&brand_con=<?php echo $sanpham['id'] ?>"><?php echo $sanpham['brand_con'] ?></a>
                                            </div>
                                            <?php } ?>
