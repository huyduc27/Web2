...
function select_top10(){
    $sql = "SELECT * FROM sanpham as a INNER JOIN chitiet_sanpham as b ON a.id_pro = b.id_pro INNER JOIN anh_sp as c ON a.id_pro = c.id_pro GROUP BY RAND(b.id_chitiet) ORDER BY luotxem DESC LIMIT 0,10";
    return pdo_query($sql);
}
